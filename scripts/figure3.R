...
fig3A <- grid.arrange(temp.gg, pol.assemb.gg, eq.assemb.gg, ncol=1)
ggsave(fig3A, filename=here("results","fig3_part1.png"),height=8, width=4, dpi=300, scale=1.1)
fig3B <- grid.arrange(poldat.lm.gg, eqdat.lm.gg, ncol=2)
ggsave(fig3B, filename=here("results","fig3_part2.png"),height=8, width=7, dpi=300, scale=0.95)
